...
Your task is to generate well-structured recipes in English.
You can produce Ingredients and Instructions sections.
"""
...
def index():
    ...
    return Titled('Recipe Generator Chatbot', page)
